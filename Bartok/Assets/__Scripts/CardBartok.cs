...
public class CardBartok : Card {
	// Static variables are used by each copy of CardBartok
	...
	// Fields with information, necessary in order to move and rotate map
	...
	// Per complition cards' movements reportFinishTo.SendMessage()
	// will be called
	...
	///<summary>
	///Starts movement of the card to new displacement with given rotation
	///</summary>
	public void MoveTo(Vector3 ePos, Quaternion eRot){
		bezierPts = new List<Vector3>();
		bezierPts.Add( transform.localPosition ); // Modern displacement
		bezierPts.Add( ePos ); // New displacement
	...
	///<summary>
	///Starts movement of the card to new displacement without rotation 
	///</summary>
